...
<html lang="en">
  <head>
    ...
    <title>Viralixa - @yield('title')</title>
    <!-- Bootstrap core CSS -->
  ...
  <section id="container" >
      <header class="header black-bg">
            ...
            <!--logo start-->
            <a href="index.html" class="logo"><b>VIRALIXA</b></a>
            <!--logo end-->
                ...
                <ul class="nav top-menu">
                    ...
                    <li id="header_inbox_bar" class="dropdown">
                        ...
                        <ul class="dropdown-menu extended inbox">
                            ...
                            <li>
                                <a href="index.html#">
                                    <span class="photo"><img alt="avatar" src="{{ asset('img/ui-danro.jpg') }}"></span>img/ui-danro.jpg
                                    <span class="subject">
            ...
            <div class="top-menu">
                <ul class="nav pull-right top-menu">
                    <li><a class="logout" href="{{ url('users/logout') }}">Logout</a></li>
                </ul>
            </div>
        </header>